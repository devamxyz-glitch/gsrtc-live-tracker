    ...
    <div class="list">
      ...
      <div class="list-row">
        ...
        ${seg('text', [['normal', t('textNormal')], ['large', t('textLarge')]], s.text)}
            ...
            <div class="list-row st-setting-smart-safety">
        <span class="row-glyph">${icon('shield')}</span>
        <span class="lbl">Smart Safety
          <span class="hint">Show bus catch-time and boarding guidance</span>
        </span>
        ${seg('smartSafety', [['on', 'On'], ['off', 'Off']], s.smartSafety === false ? 'off' : 'on')}
      </div>
<div class="list-row">
